...
privileged aspect ProductBean_Roo_ManagedBean {
    ...
    public HtmlPanelGrid ProductBean.populateCreatePanel() {
        ...
        OutputLabel productTypeCreateOutput = (OutputLabel) application.createComponent(OutputLabel.COMPONENT_TYPE);
        productTypeCreateOutput.setFor("productTypeCreateInput");
        ...
        OutputLabel releaseDateCreateOutput = (OutputLabel) application.createComponent(OutputLabel.COMPONENT_TYPE);
        releaseDateCreateOutput.setFor("releaseDateCreateInput");
    ...
    public HtmlPanelGrid ProductBean.populateEditPanel() {
        ...
        OutputLabel productTypeEditOutput = (OutputLabel) application.createComponent(OutputLabel.COMPONENT_TYPE);
        productTypeEditOutput.setFor("productTypeEditInput");
        ...
        OutputLabel releaseDateEditOutput = (OutputLabel) application.createComponent(OutputLabel.COMPONENT_TYPE);
        releaseDateEditOutput.setFor("releaseDateEditInput");
